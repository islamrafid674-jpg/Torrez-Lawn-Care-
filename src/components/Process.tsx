      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-2xl">
            <h2 className="text-emerald-600 font-semibold tracking-widest uppercase text-sm mb-4">Our Methodology</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 border-t border-stone-200 pt-12">
          {steps.map((step, index) => (
            ...
            >
              <div className="text-6xl md:text-7xl font-display font-light text-stone-200 mb-6 group-hover:text-emerald-600 transition-colors duration-500">
                0{index + 1}
              </div>
              <h4 className="text-2xl font-display font-semibold text-stone-900 mb-4">{step.title}</h4>
